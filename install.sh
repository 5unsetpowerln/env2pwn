...
wget https://raw.githubusercontent.com/iwashiira/sig-beginners-pwn-public/main/.gdbinit -O root/.gdbinit
sudo cp root/.gdbinit /root
wget https://raw.githubusercontent.com/iwashiira/sig-beginners-pwn-public/main/.bashrc -O root/.bashrc
...
if [ -e root/.rbenv ]; then
    sudo rm -r root/.rbenv
fi
